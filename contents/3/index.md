...
그렇지만 이러한 아키텍처 구조가 마이크로 서비스가 지향하는 유연성, 확장성을 지원하는 구조이기에 강조되어지고 있습니다.  
...
그렇지만 분리해도 복잡성은 여전히 이전되고 그 안의 복장성을 통제할 필요가 있다는 사실은 변하지 않게 됩니다.  

<br/>

마이크로 서비스 내부 구조를 정의할 때 반드시 내부 구조의 다양성을 고려해야 합니다.  
