...
|<img src="https://github.com/cholnh/delivery-platform-server-guide/blob/main/assets/images/3/msa-pattern-layered-arch.png" width="400"/>|
|-|
|전통적인 3계층 아키텍처|
...
|<img src="https://github.com/cholnh/delivery-platform-server-guide/blob/main/assets/images/3/msa-pattern-dip.png" width="700"/>|
|-|
|의존 관계 역전의 적용|
...
|<img src="https://github.com/cholnh/delivery-platform-server-guide/blob/main/assets/images/3/multi-architectural-patterns-polyglot-microservices.png" width="1000"/>|
|-|
|다양한 아키텍처 패턴의 폴리글랏 마이크로 서비스 (출처: [마이크로소프트에서 정의한 멀티 아키텍처](https://docs.microsoft.com/ko-kr/dotnet/architecture/microservices/multi-container-microservice-net-applications/microservice-application-design))|
...
- 트랜젝션 스크립트 패턴  
    ...
    |<img src="https://github.com/cholnh/delivery-platform-server-guide/blob/main/assets/images/3/msa-pattern-transaction-pattern.png" width="600"/>|
    |-|
    |트랜젝션 스크립트 패턴|
...
- 도메인 모델 패턴  
    ...
    |<img src="https://github.com/cholnh/delivery-platform-server-guide/blob/main/assets/images/3/msa-pattern-domain-model-pattern.png" width="700"/>|
    |-|
    |도메인 모델 패턴|
...
부드러운(Soft) 소프트웨어를 만들기 위해선 클라우드 플랫폼이나 카버네티스 같은 아키텍처를 적용하는 것 만으로도 유연하고 기민해 질 수 있습니다.  
...
[다음장](https://github.com/cholnh/delivery-platform-server-guide/blob/main/contents/4/index.md#배달-서비스-플랫폼-api-서버-가이드)
