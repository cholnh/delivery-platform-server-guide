...
|<img src="https://github.com/cholnh/delivery-platform-server-guide/blob/main/assets/images/2/ddd-bc-diagram-2.png" width="1000"/>|
|-|
|컨텍스트 간의 호출 관계|
...
|-|-|
|커멘드|외부 영역의 인바운드 어댑터 :arrow_right: API 후보|
