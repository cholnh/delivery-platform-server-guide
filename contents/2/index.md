...
- 리뷰 관리
     + (Create) (해당 업체에서 구매한 고객에 한에) 고객은 업체 평가를 등록할 수 있습니다.
     + (Update) 고객은 자신이 작성한 업체 평가를 수정할 수 있습니다.
     + (Delete) 고객은 자신이 작성한 업체 평가를 삭제할 수 있습니다.
     + 사용자는 업체 평가를 조회할 수 있습니다.
     + 사용자는 제품 평가를 조회할 수 있습니다.
     + 사용자는 업체 평가에 (작성자 외 로그인된 고객/업주에 한에) 좋아요 및 댓글을 작성할 수 있습니다.
...
이것은 비즈니스 해결을 위한 문제영역 입니다.  
DDD 에서는 문제 영역을 서브도메인이라 부릅니다.  
서브도메인별로 이벤트 스토밍을 진행하겠습니다.  
