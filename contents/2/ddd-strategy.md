...
- 유비쿼터스 언어  
    ...
    유비쿼터스 언어는 특정 프로젝트에서만 사용하는 단어/용어사전과 같은 역할을 합니다.  
...
- 도메인 모델과 바운디드 컨텍스트   
    ...
    무리없이 의사소통할 수 있다면 서비스는 지속적으로 민첩하게 개발/유지될 수 있습니다.  
...
- 컨텍스트 매핑  
    하나의 큰 도메인을 여러 개의 바운디드 컨텍스트로 식별하면 비즈니스 수행을 위해 여러개의 컨텍스트가 연계해야 하는 경우가 발생합니다. 
